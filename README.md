...
# Диагностика — полный отчёт (версия, платформа, бинарники, сеть/TUN, маршрутизация,
# dnsmasq, системные логи, сгенерированный конфиг с замазанными ключами) для отчёта о проблеме
